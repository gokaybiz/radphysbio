...
class Database extends Dexie {
  ...
  constructor() {
    ...
    this.version(0.1).stores({
      data: "++id,ExpID0,PMID1,Exp2,CellLine3,Tissue4,CellClass5,CellCycle6,EnergyMeV8,RBE9,LETkeVm10,DoseRateGymin11,Alpha12,Beta13,DSBsGyGbp14,FiguresTables,nonDSBClustersGyGbp15,keVDSBsO16,keVOtherO17,keVDSBsO18,keVOtherO19,keVDSBsO20,keVOtherO21,keVDSBsO22,keVOtherO23,TypeofRadiation24,IrradiationConditions27,DSBsO29,OtherO30,DSBsO31,OtherO32,Source33", // data store here with auto-increment primary key and other columns as indexes
